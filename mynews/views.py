...
def home(request):
    ...
    return render(request, "home.html", context) # FIXED PATH
...
def national_news(request):
    ...
    context.update(get_common_sidebar_data())
    return render(request, "category_news.html", context) # FIXED PATH
...
def news_detail(request, url_city, slug): 
    ...
    context.update(get_common_sidebar_data())
    return render(request, "news_detail.html", context) # FIXED PATH
...
def district_news(request, district):
    ...
    context.update(get_common_sidebar_data())
    return render(request, "district_news.html", context) # FIXED PATH
...
def contact_us(request):
    ...
    context.update(get_common_sidebar_data())
    return render(request, "contact_us.html", context) # FIXED PATH

def privacy_policy(request): return render(request, "privacy_policy.html") # FIXED
def about_us(request): return render(request, "about_us.html") # FIXED
def disclaimer(request): return render(request, "disclaimer.html") # FIXED
