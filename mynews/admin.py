...
# Cloudinary Optimization Function with your new Cloud Name
def get_optimized_url(url, width=100, height=100, crop="fill"):
    if not url: return None
    
    # Aapka Naya Cloud Name
    cloud_name = "dvoqsrkkq" 
    
    # Agar URL bahar ka hai (jaise i.ibb.co), to 'fetch' gateway zaroori hai
...
class NewsAdmin(admin.ModelAdmin):
    ...
    def display_thumb(self, obj):
        # Pehle image_url (ImgBB) check karein, fir local image
