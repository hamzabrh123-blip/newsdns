# Generated by Django 5.2.7 on 2026-02-08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('district', models.CharField(blank=True, choices=[
                    ...
                    ('Delhi', 'दिल्ली'), ('National', 'राष्ट्रीय खबर'), ('International', 'अंतर्राष्ट्रीय'), 
                    ('Sports', 'खेल समाचार'), ('Bollywood', 'बॉलीवुड'), ('Technology', 'टेक्नोलॉजी'), 
                    ('Market', 'मार्केट भाव')
            ...
            options={
                'db_table': 'mynews_news', # Ise simple rakha hai taaki clash na ho
            },
        ),
    ]
